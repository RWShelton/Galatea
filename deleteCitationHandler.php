...
<?php
  ...
  if ($sourceID > 0 and $sectionID > 0) {
    $query = "DELETE from Section WHERE section_id = " . $sectionID . ";";
  } else if ($sourceID > 0 and !$sectionID > 0) {
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-1">That citation has been deleted from the database.</h1>
          </div>
        </div>
      </div>
    </header>
